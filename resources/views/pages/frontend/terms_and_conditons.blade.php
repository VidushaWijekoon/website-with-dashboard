...
@section('title', 'Rtech | Term and Condtions')
@section('content')
<section>
    Terms and Conditions
    OVERVIEW
    These Terms of Service pertain to the website MicrobeeGlobal.com which is owned by Al Sakb Computer Devices &
    Mobiles
    Phone TR LLC. Throughout the site, the terms “Company”, “we”, “us” and “our” refer to Al Sakb Computer Devices &
    Mobiles
    Phone TR LLC and MicrobeeGlobal.com as the Won E-commerce Website. The company offers this website, including all
    ...
    of
    the site, you agree to be bound by these Terms of Services. If you do not agree to all the terms and conditions of
    this
    agreement, then you may not access the website or use any services. If these Terms of Service are considered an
    offer,
    ...
    (a)
    transmissions over various networks; and (b) changes to conform and adapt to the technical requirements of
    connecting
    ...
    or
    access to the Service or any contact on the website through which the service is provided, without express wrote
    permission by us.

    ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION
    We are not responsible if information made available on this site is not accurate, complete, or current. The
    material on
    this site is provided for general information only and should not be relied upon or used as the sole basis for
    making
    decisions without consulting primary, more accurate, more complete or timelier sources of information. Any reliance
    on
    ...
    the
    website. We cannot guarantee that your computer monitor’s display of any color will be accurate.
    ...
    change at any time without notice, at the sole discretion of us. We reserve the right to discontinue any product at
    any
    ...
    customer account, the same credit card, and/or orders that use the same billing and/or shipping address. In the
    event
    ...
    representations, or conditions of any kind and without any endorsement. We shall have no liability whatsoever
    arising
    ...
    USER COMMENTS, FEEDBACK, REVIEWS AND OTHER SUBMISSIONS
    ...
    no
    obligation (1) to maintain any comments in confidence; (2) to pay compensation for any comments; or (3) to respond
    to
    any comments.
    ...
    personality, or other personal or proprietary rights. You further agree that your comments will not contain libelous
    or
    ...
    or
    omissions that may relate to product descriptions, pricing, promotions, offers, product shipping charges, transit
    times
    ...
    including
    without limitation, pricing information, except as required by law. No specified update or refresh date applied in
    the
    ...
    functionality or operation of the Service or of any related website, other websites, or the Internet; (h) to collect
    or
    track the personal information of others; (i) to spam, phish, pharm, pretext, spider, crawl, or scrape; (j) for any
    obscene or immoral purpose; or (k) to interfere with or circumvent the security features of the Service or any
    related
    ...
    You agree you are at least 18 years of age or the age of majority in your state or province of residence, and you
    have
    ...
    A breach or violation of any of the Terms will result in an immediate termination of your Services and/or legal
    prosecution.
    ...
    In no case shall alsakbcomputer.com, our directors, officers, employees, agents, contractors, interns, suppliers,
    ...
    for
    any other claim related in any way to your use of the Service or any product, including, but not limited to, any
    errors
    or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any
    content (or product) posted, transmitted, or otherwise made available via the Service, even if advised of their
    possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for
    consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum
    extent permitted by law.

    INDEMNIFICATION
    You agree to indemnify, defend and hold harmless AlsakbComputer and our parent, subsidiaries, partners, officers,
    ...
    your
    breach of these Terms of Service or the documents they incorporate by reference or your violation of any law or the
    ...
    construed in
    accordance with the laws of United Arab Emirates.
    ...
    continued use of or access to our website or the Service following the posting of any changes to these Terms of
    Service
    constitutes acceptance of those changes.

    CONTACT INFORMATION
    Questions about the Terms of Service should be sent to us at support@microbeeglobal.com

    AlsakbComputer.com and microbeeglobal.com
    C/O Al Sakb Computer Devices & Mobiles Phone TR LLC
    Shubra No.15 – 19,Maliha Rd – behind City Retail Hypermarket

    Industrial Area 5 – Al Sharjah,
    P.O. Box 33453
    Sharjah, United Arabs Emirates
</section>
@endsection