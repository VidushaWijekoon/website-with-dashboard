                ...
                <form action="{{ route('posts.index') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input class="form-control form-control-sm" type="file" style="min-height: 0px" multiple
                                name="image[]">
                            <small class="form-text text-muted"> Allowed images: pdf, doc.</small>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Contact Number" data-role="tagsinput"
                    ...
                    <div class="m-t-20 text-center">
                        <button class="btn btn-primary btn-sm">Publish post</button>
                    </div>
                </form>
            </div>
        </div>
