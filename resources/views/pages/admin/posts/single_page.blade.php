                ...
                <div class="blog-view">
                    <article class="blog blog-single-post">
                        ...
                        <div class="blog-image">
                            <a href="#."><img alt="" src="{{ asset('admin/img/blog/blog-01.jpg') }}"
                                    class="img-fluid"></a>
                        </div>
                        <div class="blog-content">
                            ...
                            <blockquote>
                                <p>Vestibulum id ligula porta felis euismod semper. Sed posuere consectetur est at
                                    ...
                                    vestibulum. Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget
                            ...
                            <li>
                                <div class="comment">
                                    <div class="comment-author">
                                        <img class="avatar" alt="" src="{{ asset('admin/img/user.jpg') }}">
                                    </div>
                                    <div class="comment-block">
                                        <span class="comment-by">
                                            <span class="blog-author-name">Diana Bailey</span>
                                            <span class="float-right">
                                                <span class="blog-reply"><a href="#."><i class="fa fa-reply"></i>
                                                        Reply</a></span>
                                            </span>
                                        </span>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra euismod
                                            ...
                                            viverra euismod odio, gravida pellentesque urna varius vitae. Sed dui lorem,
                                            adipiscing in adipiscing et, interdum nec metus. Mauris ultricies, justo eu
                                        ...
                                        <div class="comment">
                                            ...
                                            <div class="comment-block">
                                                <span class="comment-by">
                                                    ...
                                                    <span class="float-right">
                                                        <span class="blog-reply"><a href="#."><i
