        ...
        <div class="row">
            ...
            <div class="col-lg-8 entries">
                ...
                <article class="entry entry-single">
                    ...
                    <div class="entry-img">
                        <img src="{{ asset('rtech/images/science_technology/sample/blog-1.jpg') }}" alt=""
                            class="img-fluid">
                    </div>
                    ...
                    <div class="entry-content">
                        ...
                        <img src="{{ asset('rtech/images/science_technology/sample/blog-inside-post.jpg') }}"
                            class="img-fluid" alt="">
                ...
                <div class="blog-comments">
                    ...
                    <div id="comment-1" class="comment">
                        <div class="d-flex">
                            <div class="comment-img">
                                <img src="{{ asset('rtech/images/science_technology/sample/comments-1.jpg') }}" alt="">
                            </div>
                            <div>
                    ...
                    <div id="comment-2" class="comment">
                        <div class="d-flex">
                            <div class="comment-img">
                                <img src="{{ asset('rtech/images/science_technology/sample/comments-2.jpg') }}" alt="">
                            </div>
                            <div>
                        ...
                        <div id="comment-reply-1" class="comment comment-reply">
                            <div class="d-flex">
                                <div class="comment-img">
                                    <img src="{{ asset('rtech/images/science_technology/sample/comments-3.jpg') }}"
                                        alt="">
                                </div>
                                <div>
                            ...
                            <div id="comment-reply-2" class="comment comment-reply">
                                <div class="d-flex">
                                    <div class="comment-img">
                                        <img src="{{ asset('rtech/images/science_technology/sample/comments-4.jpg') }}"
                                            alt="">
                                    </div>
                                    <div>
                    ...
                    <div id="comment-3" class="comment">
                        <div class="d-flex">
                            <div class="comment-img">
                                <img src="{{ asset('rtech/images/science_technology/sample/comments-5.jpg') }}" alt="">
                            </div>
                            <div>
                    ...
                    <div id="comment-4" class="comment">
                        <div class="d-flex">
                            <div class="comment-img">
                                <img src="{{ asset('rtech/images/science_technology/sample/comments-6.jpg') }}" alt="">
                            </div>
                            <div>
                ...
                <div class="sidebar">
                    ...
                    <div class="sidebar-item recent-posts">
                        <div class="post-item clearfix">
                            <img src="{{ asset('rtech/images/science_technology/sample/blog-recent-1.jpg') }}" alt="">
                            <h4><a href="#">Nihil blanditiis at in nihil autem</a></h4>
                            <time datetime="2020-01-01">Jan 1, 2020</time>
                        </div>

                        <div class="post-item clearfix">
                            <img src="{{ asset('rtech/images/science_technology/sample/blog-recent-2.jpg') }}" alt="">
                            <h4><a href="#">Quidem autem et impedit</a></h4>
                            <time datetime="2020-01-01">Jan 1, 2020</time>
                        </div>

                        <div class="post-item clearfix">
                            <img src="{{ asset('rtech/images/science_technology/sample/blog-recent-3.jpg') }}" alt="">
                            <h4><a href="#">Id quia et et ut maxime similique occaecati ut</a></h4>
                            <time datetime="2020-01-01">Jan 1, 2020</time>
                        </div>

                        <div class="post-item clearfix">
                            <img src="{{ asset('rtech/images/science_technology/sample/blog-recent-4.jpg') }}" alt="">
                            <h4><a href="#">Laborum corporis quo dara net para</a></h4>
                            <time datetime="2020-01-01">Jan 1, 2020</time>
                        </div>

                        <div class="post-item clearfix">
                            <img src="{{ asset('rtech/images/science_technology/sample/blog-recent-5.jpg') }}" alt="">
